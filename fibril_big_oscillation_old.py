...
if(track==1):
    ...
    ax1.imshow(cube,
               cmap = 'gray', origin = 'lower', aspect=1.25,
...
for oo in range(len(file_search(outdir, "cut"+cut_file[-11:-5]+"*txt"))):
    ...
    if (oo ==15 or oo==7 or oo==11 or oo==5):
        ax1.plot(trange, smth_y, color = 'red', alpha = 0.5, label = r'smthd I$_{\rm{max}}$', linewidth = 2)
        if (oo==11):
            ax1.text(trange[0]+1, smth_y[0]+1.5, "1", color = 'red')
        if (oo==7):
            ax1.text(trange[0]+1, smth_y[0]+1.5, "2", color = 'red')
        if (oo==15):
            ax1.text(trange[0]+1, smth_y[0]+1.5, "3", color = 'red')
        if (oo==5):
            ax1.text(trange[0]+1, smth_y[0]+1.5, "4", color = 'red')
    ...
    if (oo==6):
        ...
        ax2.plot(trange, smth_y, color = 'white', alpha = 0.5, label = r'smthd I$_{\rm{max}}$', linewidth = 1.)
    ...
    if (oo==6):
        ...
        ax3.plot(trange, smth_y, color = 'black', alpha = 0.5, label = r'smthd I$_{\rm{max}}$', linewidth = 1.)
